/**
 * ThemeOverridesPage — promoted to a dedicated route.
 *
 * Route: /theme-overrides
 *
 * This is the existing OverrideShowcase promoted to its own route.
 * All 5 tabs are preserved unchanged:
 *   Default / Tokens / Component / Host / Inline
 *
 * The page is deliberately kept as close to the original App.tsx OverrideShowcase
 * as possible so integrators can compare what the underlying code does.
 */
...
export function ThemeOverridesPage() {
  ...
  return (
    ...
    >
      {/* Tab bar — data-testid attributes added for Playwright navigation */}
