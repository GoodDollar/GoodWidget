/**
 * SuperfluidCampaignWidget — Theme Overrides — demonstrates the widget's public theming
...
const meta: Meta<OverridesArgs> = {
  title: 'Widgets/SuperfluidCampaignWidget/Theme overrides',
    ...
    return (
      <div style={{ display: 'grid', gap: 24, maxWidth: 560, margin: '0 auto' }}>
        ...
        <div style={{ padding: '20px', background: '#0f172a', borderRadius: 8 }}>
           <SuperfluidCampaignWidgetThemeOverridesStory themeOverrides={themeOverrides} />
        </div>
      </div>
    )
  },
