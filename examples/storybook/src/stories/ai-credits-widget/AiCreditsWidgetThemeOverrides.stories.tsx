/**
 * AiCreditsWidget — Theme Overrides — demonstrates the widget's public theming
...
import { GuidanceCardDefaultStory as AiCreditsWidgetThemeOverridesStory } from "../helpers/aiCreditsWidgetStories"
    ...
    return (
      <div style={{ display: 'grid', gap: 24, maxWidth: 560, margin: '0 auto' }}>
        ...
        <div style={{ padding: '20px', background: '#0f172a', borderRadius: 8 }}>
           <AiCreditsWidgetThemeOverridesStory themeOverrides={themeOverrides} />
        </div>
      </div>
    )
  },
