...
>
  ...
  >
    <DocsGrid>
      ...
      <DocsCard title="S2 – Purchase Setup">Buy tab — buyer key / consent / amounts in progress.</DocsCard>
      <DocsCard title="S3 – Quote Ready">Buy tab — on-chain quote built; ready to pay.</DocsCard>
  ...
  >
    <DocsGrid>
      <DocsCard title="Buy Credits">Purchase flow: buyer key, operator consent, amounts, and pay.</DocsCard>
