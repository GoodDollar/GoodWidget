...
>
  ...
  >
    <DocsGrid>
      ...
      <DocsCard title="S1b – Setup tab">Connected wallet — onboarding for Download AntSeed, Signer Key, and Authorize Wallet. The authorization step opens the same consent flow used by Buy Credits.</DocsCard>
