  ...
  return (
    <MockStoryShell
      ...
      adapterFactory={createAdapterFactory('has_credits', {
        ...
        buyerKeyPrivate: '0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef',
        operatorConsentSigned: true,
        depositAmount: '25',
        streamAmount: '5',
        ...
        usageLog: [
          ...
          {
            sessionId: 'funding-002',
            timestamp: '2026-06-24T11:00:00Z',
            creditsUsed: 12.0,
            model: 'G$ stream update',
            kind: 'funding',
            source: 'streamUpdate',
            gdAmount: '5.00',
          },
          {
            sessionId: 'funding-003',
