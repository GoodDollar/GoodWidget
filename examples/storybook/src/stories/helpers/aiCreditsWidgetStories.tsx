    ...
    <MockStoryShell
      ...
      adapterFactory={createAdapterFactory('quote_ready', {
        ...
        quote: {
          ...
          depositBonusUsd: '0.0000',
          streamBonusUsd: '0.0000',
          bonusPercent: 0,
          totalCredits: '2.50',
          totalCreditsUsd: '0.0225',
        },
        primaryAction: 'pay',
    ...
    <MockStoryShell
      ...
      adapterFactory={createAdapterFactory('quote_ready', {
        ...
        quote: {
          ...
          depositAmountUsd: '0.0150',
          streamAmountUsd: '0.0075',
          depositBonusUsd: '0.0015',
          streamBonusUsd: '0.0015',
          bonusPercent: 20,
          totalCredits: '3.00',
          totalCreditsUsd: '0.0255',
        },
        primaryAction: 'pay',
        primaryLabel: 'Buy AI Credits',
      })}
