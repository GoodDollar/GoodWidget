...
>
  ...
  <DocsSection
    title="Storybook demo data"
    description="Preview an active House of Alignment vote, interactive allocation sliders, funding data, and a previous executed round. The wallet and onboarding path above remains the live showcase path."
  >
    <Canvas of={ShowcaseStories.Demo} />
  </DocsSection>
