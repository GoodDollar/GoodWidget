/**
 * CitizenClaimWidget — Theme Overrides — demonstrates the widget's public theming
...
import { CustodialClaimExecutionClaimAllStory as CitizenClaimWidgetThemeOverridesStory } from "../helpers/citizenClaimWidgetStories"
    ...
    return (
      <div style={{ display: 'grid', gap: 24, maxWidth: 560, margin: '0 auto' }}>
        ...
        <div style={{ padding: '20px', background: '#0f172a', borderRadius: 8 }}>
           <CitizenClaimWidgetThemeOverridesStory themeOverrides={themeOverrides} />
        </div>
      </div>
    )
  },
